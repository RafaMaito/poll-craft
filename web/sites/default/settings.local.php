...
$is_development = (getenv('APP_ENV') === 'local' || PHP_SAPI === 'cli');
...
if ($is_development) {
  // Disable Twig and CSS/JS caches
  $config['system.performance']['css']['preprocess'] = FALSE;
  $config['system.performance']['js']['preprocess'] = FALSE;
...
$settings['trusted_host_patterns'] = [
  '^poll-craft\.lndo\.site$',
  '^localhost$',
];

// File paths.
$settings['file_public_path'] = $app_root . '/sites/default/files';
